...
class OrderHistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildFilters(orderProvider, context),
          Expanded(
            child: orderProvider.filteredOrders.isEmpty
              ...
              itemBuilder: (context, index) {
                return _buildOrderCard(
                    orderProvider.filteredOrders[index], context);
              },
            ),
          ),
        ],
                ...
                Expanded(
                  child: DropdownButtonFormField(
                    ...
                    items: [
                      ...
                      DropdownMenuItem(
                          value: 'processing', child: Text('قيد المعالجة')),
                      DropdownMenuItem(value: 'shipped', child: Text('تم الشحن')),
                      DropdownMenuItem(
                          value: 'delivered', child: Text('تم التسليم')),
                ...
                Expanded(
                  child: DropdownButtonFormField(
                    ...
                    items: [
                      ...
                      DropdownMenuItem(value: '3months', child: Text('آخر 3 أشهر')),
  ...
  Widget _buildTrackingTimeline(Order order, BuildContext context) {
    List<Map<String, String>> trackingSteps = [
      {'title': 'تم تأكيد الطلب', 'date': '10 يناير 2024 - 1:00 م', 'status': 'completed'},
      {'title': 'قيد التحضير', 'date': '12 يناير 2024 - 10:00 ص', 'status': 'completed'},
      {'title': 'تم الشحن', 'date': '14 يناير 2024 - 3:00 م', 'status': 'completed'},
      {'title': 'وصل إلى مركز التوزيع', 'date': '15 يناير 2024 - 9:00 ص', 'status': 'completed'},
      {'title': 'خارج للتسليم', 'date': '15 يناير 2024 - 2:30 م', 'status': 'completed'},
      {'title': 'تم التسليم', 'date': '15 يناير 2024 - 4:00 م', 'status': 'completed'},
    ];

    return Column(
      children: trackingSteps.map((step) => _buildTimelineStep(step, context)).toList(),
    );
  }
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            height: 20,
            decoration: BoxDecoration(
              color: step['status'] == 'completed' ? Colors.green : Theme.of(context).primaryColor,
